  ...
  return (
    <div className="min-h-svh pb-24">
      ...
      <div className="bg-navy px-4 pt-5 pb-7 relative overflow-hidden">
        ...
        <p className="text-gold font-display font-semibold text-xs tracking-widest uppercase mb-1">المغرب · Rabat</p>
        ...
        {unnamedCats.length > 0 && (
          <div>
            ...
            <div className="flex gap-3 overflow-x-auto pb-1">
              {unnamedCats.map(cat => (
                <Link key={cat.id} href={`/cats/${cat.id}/edit`} className="shrink-0">
